#!/usr/bin/env python3
"""tests/test_migite_pr_review.py - every finding in a PR review comes with a fix:
...
imports it at module load). Run: python3 -m unittest tests/test_migite_pr_review.py"""
...
def load_tool():
    spec = importlib.util.spec_from_file_location("migite_pr_review", ROOT / "migite-pr-review.py")
